...
import com.ws.wsAgenticSecurityGateway.ciso.dto.ComplianceReport.ControlEvidence;
import com.ws.wsAgenticSecurityGateway.ciso.dto.ComplianceReport.EvidenceItem;
...
/**
 * Config-driven compliance assembly: the shipped SOC 2 template filled from the live metric menu, plus the
 * upload path — parsing (JSON/YAML), unknown-metric validation, custom-template rendering, and CSV export.
 * Every value must come from the mocked real sources; the structure comes from the template.
 */
class ComplianceServiceTest {
    ...
    private final ComplianceService service =
            new ComplianceService(pdpRepo, auditRepo, agentRepo, policyService);
