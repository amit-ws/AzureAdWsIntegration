...
//package com.whiteswansecurity.uihost.service.azure;
//
//import com.microsoft.graph.models.AppRole;
//import com.microsoft.graph.models.DirectoryObject;
//import com.microsoft.graph.models.Organization;
//import com.microsoft.graph.requests.*;
//import com.whiteswansecurity.uihost.config.azure.GraphServiceClientFactory;
//import com.whiteswansecurity.uihost.domain.azure.*;
//import com.whiteswansecurity.uihost.repository.azure.AzureApplicationRepository;
//import com.whiteswansecurity.uihost.repository.azure.AzureTenantRepository;
//import com.whiteswansecurity.uihost.repository.azure.AzureUserDeviceRelationshipRepository;
...
//
//    @Async
//    public void syncAzureData(Long wsTenantId, String tenantId, String clientId, String clientSecret) {
//        this.graphClient = graphServiceClientFactory.createClient(clientId, clientSecret, tenantId);
//        this.wsTenantId = wsTenantId;
//        AzureTenant azureTenant = syncTenantData(tenantId);
//        syncApplications(azureTenant);
...
//                .get();
//        List<AzureGroup> azureGroupList = result.getCurrentPage().stream()
//                .map(graphGroup -> AzureGroup.builder()
//                        .azureId(graphGroup.id)
//                        .displayName(graphGroup.displayName)
//                        .description(graphGroup.description)
//                        .mail(graphGroup.mail)
...
//        List<AzureUserGroupMembership> memberships = new ArrayList<>();
//
//        List<String> azureUserIds = userIdMap.keySet().stream().collect(Collectors.toList());
//        azureUserIds.stream().forEach((n) -> {
//            DirectoryObjectCollectionWithReferencesPage members = this.graphClient.users(n)
//                    .memberOf()
//                    .buildRequest()
...
//        List<AzureUserDeviceRelationship> userDevices = new ArrayList<>();
//
//        List<String> azureUserIds = azureUserMap.keySet().stream()
//                .collect(Collectors.toList());
//        azureUserIds.stream().forEach((n) -> {
//            DirectoryObjectCollectionWithReferencesPage result = this.graphClient.users(n)
//                    .registeredDevices()
