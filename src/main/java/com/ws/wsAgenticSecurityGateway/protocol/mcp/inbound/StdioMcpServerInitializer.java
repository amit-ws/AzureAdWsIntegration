...
import com.ws.wsAgenticSecurityGateway.protocol.mcp.session.SessionReaperService;
import com.ws.wsAgenticSecurityGateway.protocol.mcp.transport.ServerTransportProvider;
...
public class StdioMcpServerInitializer implements ApplicationRunner {
    ...
    public StdioMcpServerInitializer(CapabilityRegistryService registryService,
