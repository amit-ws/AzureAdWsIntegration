    ...
    public void classifyAsync(EgressContext ctx, String responseText) {
        ...
        try {
            ...
            GatewayResponseClassificationEntity row = GatewayResponseClassificationEntity.builder()
                    ...
                    .producerKind(ctx.producerKind())
                    .producerServerId(ctx.producerServerId())
                    .producerAgentId(ctx.producerAgentId())
                    .rootPrincipalKind(ctx.rootPrincipalKind())
                    .rootPrincipalId(ctx.rootPrincipalId())
                    .rootPrincipalName(ctx.rootPrincipalName())
                    .rootVerified(ctx.rootVerified())
                    .direction("RESPONSE")
