...
@AllArgsConstructor
@NoArgsConstructor
public class K8SecretDTO extends K8MetadataDTO {
    Long id;
    String type;
    Boolean immutable;

    public K8SecretDTO(Long id, String apiVersion, String selfLink, String kind, String resourceVersion, Long generation,
    ...
    public K8SecretDTO(Long id, String uid, String name, String clusterId, String resourceAccountId, String wsTenantName, CloudProviderType cloudProviderType, boolean flag) {
