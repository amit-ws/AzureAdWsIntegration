...
@AllArgsConstructor
@NoArgsConstructor
public class K8DeploymentDTO extends K8MetadataDTO {
    Long id;

    public K8DeploymentDTO(Long id, String apiVersion, String selfLink, String kind, String resourceVersion, Long generation,
    ...
    public K8DeploymentDTO(Long id, String uid, String name, String clusterId, String resourceAccountId, String wsTenantName, CloudProviderType cloudProviderType, boolean flag) {
