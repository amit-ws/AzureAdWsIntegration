...
@AllArgsConstructor
@NoArgsConstructor
public class K8ConfigMapDTO extends K8MetadataDTO {
    Long id;
    Boolean immutable;


    public K8ConfigMapDTO(Long id, String apiVersion, String selfLink, String kind, String resourceVersion, Long generation,
                          ...
                          String wsTenantName, String cloudResourceAccountId, Boolean immutable, Boolean flag) {
    ...
    public K8ConfigMapDTO(Long id, String uid, String name, String clusterId, String resourceAccountId, String wsTenantName, CloudProviderType cloudProviderType, boolean flag) {
