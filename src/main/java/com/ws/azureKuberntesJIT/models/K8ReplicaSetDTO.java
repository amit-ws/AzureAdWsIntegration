...
@AllArgsConstructor
@NoArgsConstructor
public class K8ReplicaSetDTO extends K8MetadataDTO {
    Long id;

    public K8ReplicaSetDTO(Long id, String apiVersion, String selfLink, String kind, String resourceVersion, Long generation,
    ...
    public K8ReplicaSetDTO(Long id, String uid, String name, String clusterId, String resourceAccountId, String wsTenantName, CloudProviderType cloudProviderType, boolean flag) {
