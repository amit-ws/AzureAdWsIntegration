...
@AllArgsConstructor
@NoArgsConstructor
public class K8StatefulSetDTO extends K8MetadataDTO {
    Long id;

    public K8StatefulSetDTO(Long id, String apiVersion, String selfLink, String kind, String resourceVersion, Long generation,
    ...
    public K8StatefulSetDTO(Long id, String uid, String name, String clusterId, String resourceAccountId, String wsTenantName, CloudProviderType cloudProviderType, boolean flag) {
