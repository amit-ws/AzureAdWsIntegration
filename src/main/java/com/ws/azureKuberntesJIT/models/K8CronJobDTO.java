...
@AllArgsConstructor
@NoArgsConstructor
public class K8CronJobDTO extends K8MetadataDTO {
    Long id;

    public K8CronJobDTO(Long id, String apiVersion, String selfLink, String kind, String resourceVersion, Long generation,
    ...
    public K8CronJobDTO(Long id, String uid, String name, String clusterId, String resourceAccountId, String wsTenantName, CloudProviderType cloudProviderType, boolean flag) {
