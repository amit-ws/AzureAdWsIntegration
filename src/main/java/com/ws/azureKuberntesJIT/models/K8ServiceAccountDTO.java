...
@AllArgsConstructor
@NoArgsConstructor
public class K8ServiceAccountDTO extends K8MetadataDTO {
    Long id;
    Boolean automountServiceAccountToken;

    public K8ServiceAccountDTO(Long id, String apiVersion, String selfLink, String kind, String resourceVersion, Long generation,
    ...
    public K8ServiceAccountDTO(Long id, String uid, String name, String clusterId, String resourceAccountId, String wsTenantName, CloudProviderType cloudProviderType, boolean flag) {
