...
@AllArgsConstructor
@NoArgsConstructor
public class K8JobDTO extends K8MetadataDTO {
    Long id;

    public K8JobDTO(Long id, String apiVersion, String selfLink, String kind, String resourceVersion, Long generation,
    ...
    public K8JobDTO(Long id, String uid, String name, String clusterId, String resourceAccountId, String wsTenantName, CloudProviderType cloudProviderType, boolean flag) {
